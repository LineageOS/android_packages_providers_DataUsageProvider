...
public final class DataUsageUtils {
    ...
    public static void enableApp(Context context, int uid, boolean enb) {
        enableApp(context, uid, enb, null);
    }

    public static void enableApp(Context context, int uid, boolean enb, String label) {
        if (DEBUG) {
            Log.v(TAG, "enableApp: uid:" + uid + " enb:" + enb + ((label == null) ? "" : (" label:" +
                    label)));
        }
        ContentValues values = new ContentValues();
    ...
    public static boolean getAppEnable(Context context, int uid) {
        ...
        if (DEBUG) {
            Log.v(TAG, "getAppEnable: uid:" + uid + " enb:" + appEnb);
        }
    ...
    public static void enableDataUsageService(Context context, boolean enb) {
    ...
    public static void startDataUsageService(Context context, boolean enb) {
        ...
        if (DEBUG) {
            Log.v(TAG, "enableDataUsageService: enb:" + enb);
        }
    }
